...
from models import customer, role, customerManagementRole
...
def create_app(testing=False, config_name='DevelopmentConfig'):
    app = Flask(__name__)
    app.config['SQLALCHEMY_DATABASE_URI'] = 'mysql+mysqlconnector://root:Tuckerstriker12@localhost/factory_management_db'
